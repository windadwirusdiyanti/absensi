...
<head>
    ...
    <title>Absensi PT Telkom Indonesia</title>
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/logo-telkom.jpg') ?>" alt="" class="img-fluid">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2023 <a href="http://PT TELKOM.co.id">PT Telkom Indonesia</a>
                        </p>
                    </nav>
                </div>
            </footer>
